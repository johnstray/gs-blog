<?php # no-NB Language File for GetSimple Blog - Automatically generated with the Google Translate API

if ( !defined( 'IN_GS' ) ) { die( 'You cannot load this file directly!' ); } // Security Check

$i18n = array(
    'LANGUAGE_CODE'              => array( 'no_NB', 'nor', 'norwegian-bokmal', 'no', 'norwegian',  ),
    'DATE_FORMAT'                => '%c',
    'DATE_DISPLAY'               => '%B %e, %Y',
    'DATE_ARCHIVE'               => 'F Y',
    'PLUGIN_TITLE'               => 'GetSimple Blogg',
    ...
    'VERSION_UPTODATE'           => 'GetSimple Blogg er oppdatert!',
    'VERSION_BETA'               => 'Du bruker nå en betaversjon av GetSimple Blogg.',
    ...
    'VERSION_STATUS_DESC'        => 'Ensure you&apos;re running the latest version of the GetSimple Blogg plugin so that you can benefit from the latest fixes and features',
    'VERSION_UPDATESTATUS'       => 'Oppdater Status',
    'VERSION_CURRENTVER'         => 'Nåværende Versjon',
    'VERSION_LATESTVER'          => 'Siste Versjon',
    'FILTER_POSTS'               => 'Filter innlegg',
    'FILTER_DESC'                => 'Velg mellom alternativene nedenfor for å filtrere listen over innlegg',
    'CLEAR_FILTERS'              => 'Rydde filtre',
    'POST_TITLE'                 => 'Posttittel',
    'POST_AUTHOR'                => 'Forfatterens navn',
    'POST_CONTENT'               => 'Innlegg Innhold',
    'ALL_FIELDS'                 => 'Alle felt',
    'PUBLISHED_DATE'             => 'Publisert dato',
    'TAG'                        => 'stikkord',
    'SEO_SETTINGS_BUTTON'        => 'SEO Innstillinger',
    'SEO_SETTINGS_INTRO'         => 'Denne siden lar deg legge til en beskrivelse til hver av funksjonssidene som vil bli brukt i beskrivelsen hmtl metatag. Du kan også valgfritt aktivere visning av hver beskrivelse på deres respektive sider, slik at de kan brukes som innføring av siden.',
    'SEO_CATEGORIES_DESC'        => 'Kategorier Beskrivelse',
    'SEO_CATEGORIES_HINT'        => '{category} = Navn på den viste kategorien',
    'SEO_ARCHIVES_DESC'          => 'Arkivbeskrivelse',
    'SEO_ARCHIVES_HINT'          => '{archive} = Arkivets måned og år',
    'SEO_TAGS_DESC'              => 'Tags Beskrivelse',
    'SEO_TAGS_HINT'              => '{tag} = Merket som vises',
    'SEO_SEARCH_DESC'            => 'Søkeresultat Beskrivelse',
    'SEO_SEARCH_HINT'            => '{search} = Søkeordet, {filter} = Filteret som brukes',
    'SEO_SHOW_ON_PAGE'           => 'Vis på side?',
);
