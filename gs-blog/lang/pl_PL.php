<?php # pl_PL Language File for GetSimple Blog - Automatically generated with the Google Translate API

if ( !defined( 'IN_GS' ) ) { die( 'You cannot load this file directly!' ); } // Security Check

$i18n = array(
    'LANGUAGE_CODE'              => array( 'pl_PL', 'pl', 'plk', 'polish',  ),
    'DATE_FORMAT'                => '%c',
    'DATE_DISPLAY'               => '%B %e, %Y',
    'DATE_ARCHIVE'               => 'Y.m',
    ...
    'RSS_CONTENT_DESCRIPTION'    => 'Dołączaj treść RSS lub podsumowanie',
    'RSS_INCLUDE_CONTENT'        => 'Pełna treść',
    'RSS_INCLUDE_EXCERPT'        => 'Utwórz fragment',
    ...
    'VERSION_UPTODATE'           => 'GetSimple Blog jest w najnowszej wersji.',
    'VERSION_BETA'               => 'Obecnie używasz wersji testowej GetSimple Blog.',
    ...
    'VERSION_STATUS_DESC'        => 'Upewnij się, że używasz najnowszej dostępnej wersji wtyczki GetSimple Blog, by móc korzystać z najnowszych funkcjonalności i poprawek.',
    'VERSION_UPDATESTATUS'       => 'Status aktualizacji',
    'VERSION_CURRENTVER'         => 'Zainstalowana wersja',
    'VERSION_LATESTVER'          => 'Najnowsza wersja',
    'FILTER_POSTS'               => 'Filtruj posty',
    'FILTER_DESC'                => 'Wybierz jedną z poniższych opcji, aby filtrować listę postów',
    'CLEAR_FILTERS'              => 'Wyczyść filtry',
    'POST_TITLE'                 => 'Tytuł wpisu',
    'POST_AUTHOR'                => 'Imię autora',
    'POST_CONTENT'               => 'Publikuj treść',
    'ALL_FIELDS'                 => 'Wszystkie pola',
    'PUBLISHED_DATE'             => 'Data publikacji',
    'TAG'                        => 'Etykietka',
    'SEO_SETTINGS_BUTTON'        => 'Ustawienia SEO',
    'SEO_SETTINGS_INTRO'         => 'Ta strona umożliwia dodanie opisu do każdej z stron funkcji, która będzie następnie używana w tagu meta description hmtl. Można również opcjonalnie włączyć wyświetlanie każdego opisu na odpowiednich stronach, tak aby mogły być używane jako wprowadzenie strony.',
    'SEO_CATEGORIES_DESC'        => 'Kategorie Opis',
    'SEO_CATEGORIES_HINT'        => '{category} = Nazwa wyświetlanej kategorii',
    'SEO_ARCHIVES_DESC'          => 'Opis archiwum',
    'SEO_ARCHIVES_HINT'          => '{archive} = miesiąc i rok archiwum',
    'SEO_TAGS_DESC'              => 'Tagi Opis',
    'SEO_TAGS_HINT'              => '{tag} = wyświetlany tag',
    'SEO_SEARCH_DESC'            => 'Opis wyników wyszukiwania',
    'SEO_SEARCH_HINT'            => '{search} = wyszukiwane hasło, {filter} = używany filtr',
    'SEO_SHOW_ON_PAGE'           => 'Pokaż na stronie?',
);
