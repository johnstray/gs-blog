...
$i18n = array(
  ...
  'RSS_HEADER'                =>  'Importateur automatique de flux RSS',
  ...
  'SETTINGS_RSS_DESC'         =>  'Configurez les paramètres de l&apos;importateur automatique de flux RSS. L&apos;importateur automatique peut importer ou bien le contenu entier des flux ou bien un extrait avec un lien vers l&apos;article original.', // Modified string in v3.4.1 ('Summary' changed to 'Excerpt') [not yet re-translated]
  'RSS_IMPORTER'              =>  'Activer l&apos;importateur RSS',
  'RSS_CONTENT_DESCRIPTION'   =>  'Inclure contenu RSS ou extrait', // Modified string in v3.4.1 ('Summary' changed to 'Excerpt') [not yet re-translated]
