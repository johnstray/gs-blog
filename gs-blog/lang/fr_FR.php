 ...
 */
$i18n = array(
  'LANGUAGE_CODE'     => 'fr_FR',               // ISO Language Code string
  ...
  'DATE_ARCHPRE'      => 'F Y',                 // Date format for Archive Pre-Title
	'PLUGIN_TITLE' 			=> "Blog GetSimple",
	'PLUGIN_DESC' 			=> "Une solution simple pour mettre en place un Blog sur GetSimple.",
	'PLUGIN_SIDE' 			=> "Gestion du Blog",
	'WRITE_OK' 			=> "Fichier écrit avec succès",
	'EDIT_OK' 			=> "Fichier édité avec succès",
	'POST_DELETED' 			=> "Article effacé avec succès",
	'POST_DELETED_ERROR' 		=> "Cet article ne peut être effacé !",
	'CATDELETED' 			=> "Catégorie effacée avec succès",
	'CATCREATED'       		=> "Catégorie créée avec succès",
	'HELP' 				=> ">Aide",
	'ALL_FAQ' 			=> ">Tous les articles",
	'POST_SLUG'			=> "Slug/URL",
	'POST_TAGS'			=> "Tags (séparer les tags par des virgules)",
	'POST_DATE'			=> "Date de plublication (mm/dd/yyyy) et horaire (hh:mm:ss pm)",
	'POST_PRIVATE'			=> "Cet article est privé",
	'POST_OPTIONS'			=> "Options d'article",
	'POST_CATEGORY'			=> "Associéer cet article à une catégorie",
	'SAVE_POST'			=> "Enregistrer l'article",
	'CANCEL'			=> "Annuler",
	'DELETE'			=> "Effacer",
	'OR'				=> "Ou",
	'PAGE_URL'			=> "Page to display blog posts",
	'EXCERPT_LENGTH'		=> "Longueur du résumé (caractères):",
	'LANGUAGE'			=> "Langue",
	'POSTS_PER_PAGE'		=> "&num; d'articles par pages",
	...
	'YES'				=> "Oui",
	'NO'				=> "Non",
	'NO_POSTS'			=> "Pas d'articles",
	'OLDER_POSTS'			=> "Anciens articles",
	'NEWER_POSTS'			=> "Nouveaux articles",
	'ALL_CATEOGIRES'		=> "Voir toutes les catégories",
	'SEARCH'			=> "Recherche du Blog",
	'FOUND'				=> "Ces articles furent trouvés :",
	'NOT_FOUND'			=> "Aucun artcile trouvé.",
	'CATEGORIES' 			=> "Catégories",
	'VIEW_ALL' 			=> "Tout voir",
	'VIEW' 				=> "Voir",
	'ADD_P' 			=> "Ajouter un nouvel article",
	'EDIT_CONTENT' 			=> "Editer le contenu : ",
	'EDIT' 				=> "Editer ",
	'POST' 				=> "Aticle",
	...
	'ADD_CAT' 			=> "Ajouter catégorie", 
	'CAT_TITLE' 			=> "Titre de catégorie ...", 
	'DEL_CAT1' 			=> "Effacer un catégorie : ",
	'DEL_CAT2' 			=> "?? This Will Delete ALL* content In The Category As Well!",
	'CONTENT' 			=> "contenu",
	'YR_CATNAME' 			=> "Votre nom de catégorie",
	'HELP' 				=> "Aide", 
	'SETTINGS' 			=> "Paramètres", 
	'RSS_FEEDS' 			=> "Flux RSS", 
	'CATEGORIES' 			=> "Catégories", 
	...
	'ADD_FEED' 			=> "Ajouter flux RSS", 
	'MANAGE_FEEDS' 			=> "Ajouter &amp; Gérer les flux RSS", 
	'ADD_NEW_FEED' 			=> "Ajouter un nouveau Flux RSS", 
	'BLOG_CATEGORY' 		=> "Blog Category", 
	'CATEGORY_NAME' 		=> "Category Name", 
	'ADD_CATEGORY' 			=> "Ajouter une catégorie", 
	'MANAGE_CATEGORIES' 		=> "Ajouter &amp; Gérer les catégories", 
	'RSS_FEED' 			=> "Flux RSS", 
	'FEED_CATEGORY' 		=> "RSS Feed Category", 
	'DELETE_FEED' 			=> "Effacer le flux", 
	'TAGS' 				=> "Tags", 
	'DISPLAY_TAGS_UNDER_POST' 	=> "Afficher les Tags sous l'article ?", 
	...
	'POST_THUMBNAIL' 		=> "Activer les miniatures d'article", 
	//Added version 1.0.2 
	...
	'POST_THUMBNAIL_LABEL' 		=> "Upload Thumbnail",
	//ADDED VERSION 1.1.4
	'CSS_SETTINGS' 			=> 'Paramètres CSS',
	'DISPLAY_CSS' 			=> 'Afficher les CSS',
	'CSS_CODE' 			=> 'Code CSS',
	...
	//ADDED VERSION 1.1.5
	'RSS_FEED_NUM_POSTS' 		=> '&num; d\'articles dasn le flux RSS',
	'CSS_SETTINGS' 			=> 'Paramètres CSS',
	//ADDED VERSION 1.1.6
	'RSS_FEED' 			=> 'Flux RSS',
	...
	'BLOG_PAGE_DISQUS_COMMENTS' 	=> 'Disqus Commentaires',
	'BLOG_PAGE_CREATE_EXCERPT' 	=> 'Créer résumé',
	...
	'VERSION_UPTODATE' 		=> 'GS Blog est à jour !',
	...
	'VERSION_CHECKFORUPDATE' 	=> 'Vérifier les mises à jour',
	...
	'ON' 				=> 'sur',
	'IN' 				=> 'dans',
	'CUSTOM_FIELDS_BUTTON' 		=> 'Champ personnalisé',
	'NEW_POST_BUTTON' 		=> 'Créer un article',
	'SOCIAL_BUTTON' 		=> 'Social',
	'ADVERTISEMENT_BUTTON' 		=> 'Advertisement',
	'CUSTOMIZE_BUTTON' 		=> 'Personnalisation',
	'SETTINGS_BUTTON' 		=> 'Paramètres',
	'DISPLAY_POST_AUTHOR' 		=> 'Afficher l\'auteur de l\'article',
	'DEFAULT_AUTHOR' 		=> 'Auteur par défaut',
	'DISPLAY_POST_CATEGORY' 	=> 'Afficher la catégorie de l\'article',
	'VIEW_HTACCESS' 		=> 'View what your site\'s .htaccess should be!',
	'CUSTOMIZE_HEADER' 		=> 'Personnalisation du Blog',
	'CUSTOM_PAGE_LAYOUT_HEADER' 	=> 'Personnalisation du design des pages',
	'CUSTOM_CSS_CLASS' 		=> 'Personnalisation des classes CSS',
	'VIEW_AVAILABLE_CLASSES' 	=> 'Cliquez ici pour afficher les classes et ids disponibles',
	'AVAILABLE_CLASSES' 		=> 'Classes et IDs disponibles',
	'CSS_SEARCH_FORM_HINT' 		=> 'ID du formulaire de recherche',
	...
	'UPLOAD_THUMBNAIL' 		=> 'Chargez une miniature',
	'UPLOAD_ENABLE_JAVASCRIPT' 	=> 'Veuillez activer JavaScript pour utiliser l\'uploader de fichier !',
